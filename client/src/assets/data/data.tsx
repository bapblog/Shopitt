import { footerLinksProps, prdCatProps, productsListProps } from "../../types/types";
import FemaleModal from "../../assets/images/category/femailemodle.jpg";
...
export const navCategory: navCategories[] = [
  {
    title: 'All',
    link: 'products'
  },
...
export const categories: string[] = ['All','Men','Women','Kid']
...
export const getProductsList: productsListProps[] = [
    {
...
export const footerLinksData: footerLinksProps[] = [
    ...
    },
    {
      ...
      links: [
        {
            name: "GitHub",
            redirect: "https://github.com/Harshalingole",
        },
        {
            name: "Linkedin",
            redirect: "https://www.linkedin.com/in/harshal-ingole-759a38226/",
        },
        {
            name: "Twitter",
            redirect: "https://twitter.com/HarshalIngole19",
        },
        {
            name: "Website",
            redirect: "https://harshal-ingole.netlify.app/",
        },      
      ]
    }
  ]